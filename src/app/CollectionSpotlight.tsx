    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-5 max-w-[900px] mx-auto">
                <div className="p-3 h-[571px] w-[258.88px] shadow-2xl">
                    ...
                    <div className="relative">
                        <div className="dividerCircle absolute w-5 h-10 bg-gray-200 rounded-r-full -mt-8 -left-3"></div>
                        <div className="dividerCircle absolute w-5 h-10 bg-gray-200 rounded-l-full -mt-8 -right-3"></div>
                    </div>
                    <div className="text-center">
                        <h1 className="text-lg font-bold">Las Vegas Aviators</h1>
                        <h1 className="text-sm mt-3">Oct 15 | Sun | 4:30 PM</h1>
                        <p className="text-sm text-gray-500 my-3">Las Vegas Ballpark, Las Vegas, Nevada</p>
                        <button className="text-white bg-black py-1 text-sm px-10">Take Flight Collection</button>
                ...
                <div className="p-3 h-[571px] w-[258.88px] shadow-2xl">
                    ...
                    <div className="text-center">
                        ...
                        <h1 className="text-sm mt-3">Oct 15 | Sun | 4:30 PM</h1>
                        <p className="text-sm text-gray-500 my-3">Sutter Health Park, Sacramento, California</p>
                        <button className="text-white bg-black py-1 text-sm px-10">Orange Collection</button>
