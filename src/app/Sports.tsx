    ...
    return (
        <div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5 mt-5">
                <div className="p-3 h-[552px] w-[258.88px] shadow-xl  dark:bg-[#2b2b2b]">
                    ...
                    <div className="dark:bg-[#191919] bg-gray-100 py-3 mt-3">
                        <div className="flex justify-around dark:text-white items-center text-xs text-gray-400">
                            <h3>total events</h3>
                            <h3>sport</h3>
                        </div>
                        <div className="flex justify-around items-center dark:text-gray-00 text-base font-semibold">
                            <h2>48 Events</h2>
                            <h2>Baseball</h2>
                        </div>
                    </div>
                ...
                <div className="relative p-3 h-[552px] w-[258.88px] shadow-xl dark:bg-[#2b2b2b]">
